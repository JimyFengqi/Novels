...
class DbManager(object):
    def __init__(self):
        #self.dbname=os.path.dirname(os.path.dirname(os.path.dirname(os.getcwd())))+'\\'+"xuanshugedb.sqlite3"
        self.dbname=os.path.dirname(os.path.dirname(os.path.dirname(os.getcwd())))+'/'+"xuanqugedb.sqlite3"
        print(self.dbname)
        self.db = sqlite3.connect(self.dbname)
        self.cursor = self.db.cursor()
        self.tablename= 'xuanquge_novel'
