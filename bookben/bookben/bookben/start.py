...
class DbManager(object):
    def __init__(self):
        #self.dbname=os.path.dirname(os.path.dirname(os.path.dirname(os.getcwd())))+'\\'+"bookbendb.sqlite3"
        self.dbname=os.path.dirname(os.path.dirname(os.path.dirname(os.getcwd())))+'/'+"bookbendb.sqlite3"#爱去小说
        print(self.dbname)
        self.db = sqlite3.connect(self.dbname)
        self.cursor = self.db.cursor()
        self.tablename= 'bookben_novel'
